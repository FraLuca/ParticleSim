...
class MLP_CLS(nn.Module):
    def __init__(self, cfg):
        ...
        self.fc1 = nn.Linear(cfg.MODEL.HEAD.CLASSIFIER.HIDDEN_SIZE, cfg.MODEL.HEAD.CLASSIFIER.HIDDEN_SIZE)
...
class MLP_REG(nn.Module):
    def __init__(self, cfg):
        ...
        self.fc1 = nn.Linear(cfg.MODEL.HEAD.REGRESSOR.HIDDEN_SIZE, cfg.MODEL.HEAD.REGRESSOR.HIDDEN_SIZE)
